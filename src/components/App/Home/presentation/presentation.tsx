            ...
            <div>
                ...
                <div className="hero h-min bg-base-200 my-8 py-4">
                    <div className="hero-content flex-col lg:flex-row">
                        <img src="../src/assets/vacances.png" className="max-w-xs rounded-lg shadow-2xl" />
                        <div className="mx-3">
                ...
                <div className="hero h-min bg-base-200 my-8 py-4">
                    <div className="hero-content flex-col lg:flex-row">
                        ...
                        <img src="../src/assets/temps-libre.png" className="max-w-xs rounded-lg shadow-2xl" />
                    </div>
                </div>

                <div className="hero h-min bg-base-200 my-8 py-4">
                    <div className="hero-content flex-col lg:flex-row">
                        <img src="../src/assets/comptabilite.png" className="max-w-xs rounded-lg shadow-2xl" />
                        <div className="mx-3">
                ...
                <div className="hero h-min bg-base-200 my-8 py-4">
                    <div className="hero-content flex-col lg:flex-row">
                        ...
                        <img src="../src/assets/des-photos.png" className="max-w-xs rounded-lg shadow-2xl" />
                    </div>
                </div>
