    ...
    return(
        <div className="flex md:flex-col w-full sm:flex-col">
             ...
             <div className="flex flex-1 flex-col md:w-full sm:w-full m-2"> 
                    <div className="grid h-20 card bg-lightest rounded-box place-items-center m-1">Budget avec décompte</div>
                </div>
             ...
             <div className="flex m-cold:flex md:w-full">
                ...
                <div className="flex flex-col w-full border-opacity-50 m-1">
                    <div className="grid h-20 card bg-lightest rounded-box place-items-center m-1">Ski</div>
                    <div className="grid h-20 card bg-lightest rounded-box place-items-center m-1">Randonnée</div>

                    <div className="">
                    <button className="btn btn-darkest bg-darkest text-lightest w-full hover:bg-lightest hover:text-darkest">Ajouter une activité</button>
                    </div>
                </div>
                ...
                <div className="flex flex-col w-full border-opacity-50 m-1">
                    <div className="grid h-20 card bg-lightest rounded-box place-items-center m-1">Alpes</div>
                    <div className="grid h-20 card bg-lightest rounded-box place-items-center m-1">Genève</div>

                    <div className="">
                    <button className="btn btn-darkest bg-darkest text-lightest w-full hover:bg-lightest hover:text-darkest">Ajouter une étape</button>
                    </div>
