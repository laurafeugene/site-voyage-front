function GeneralTravelMain() {
    return(
        <div className="flex flex-col sm:flex sm:flex-wrap space-x-1">

            <div className="flex flex-wrap">

                {/* contenant les activités du voyage */}

                <div className="flex flex-1 flex-col w-full m-2"> {/* récupérer les données de la base de données  pour faire le nombre de bulles relatives au activités dans l'ordre d'arrivée*/}
                ...
                <div className="flex flex-1 flex-col w-full m-2"> 
                ...
                <div className="flex flex-1 flex-col w-full m-2"> {/* récupérer les données de la base de données  pour faire le nombre de bulles relatives aux prochaines étapes (itinéraires) du voyage */}
